...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonValider = findViewById(R.id.bouton);
        buttonValider.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //On apel donc la fonction onValidate pour éviter de surcharger le code
    ...
    protected void onConfirm(View v){
        ...
        if (prenom.getText().toString().length() <= 1 || nom.getText().toString().length() <= 1 || age.getText().toString().length() <= 1 || competence.getText().toString().length() <= 1 || tel.getText().toString().length() < 10){
            v.setBackgroundColor(ContextCompat.getColor(MainActivity.this, R.color.purple_200));
            Toast.makeText(MainActivity.this,R.string.avertissement,Toast.LENGTH_SHORT).show();
        }
        else{
            ...
            alertDialogBuilder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ...
                    Intent i = new Intent(MainActivity.this, AffichageActivity.class);
            ...
            alertDialogBuilder.setNegativeButton(R.string.no, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(MainActivity.this,R.string.annulation,Toast.LENGTH_SHORT).show();
