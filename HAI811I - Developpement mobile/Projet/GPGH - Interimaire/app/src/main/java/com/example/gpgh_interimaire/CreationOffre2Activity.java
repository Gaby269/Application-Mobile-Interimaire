    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creaOffreButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(CreationOffre2Activity.this, NavbarActivity.class);
                startActivity(i);
        ...
        retourButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(CreationOffre2Activity.this, CreationOffre1Activity.class);
                //garder les intent que la personne a mis
                startActivity(i);
            }
        });
    }
